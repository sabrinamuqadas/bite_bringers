      ...
      body: Column(
        ...
        children: [
          ScaleTransition(
              scale: animation,
              child: Center(
                  child: Image.asset("image/splash_screen_icon_1.png",
                      width: Dimensions.splashImg160),),),
          Center(child: Image.asset("image/bite_bringers_1.png", width: Dimensions.splashImg260),),
        ],
      ),
    );
  }
